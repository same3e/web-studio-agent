...
Assert-True (Test-Path -LiteralPath 'templates/taste/PROFILE.template.md') 'Missing personal taste-profile template.'
...
foreach ($path in @('scripts/test_context_efficiency.ps1','scripts/context/build_repo_map.ps1','scripts/context/resolve_rules.ps1','scripts/context/compile_context.ps1','scripts/context/update_project_snapshot.ps1','docs/architecture/CONTEXT_EFFICIENCY_AUDIT.md','docs/architecture/CONTEXT_BENCHMARK.md','knowledge/context/CONTEXT_COMPILATION.md','knowledge/context/RULE_ROUTE_INDEX.json','knowledge/context/DELTA_REPORT_SCHEMA.md','templates/studio/PROJECT_SNAPSHOT.template.md','templates/studio/CONTEXT_INDEX.template.md','templates/studio/references/cards/REFERENCE_CARD.template.md','templates/studio/reports/SPECIALIST_DELTA.template.md')) { Assert-True (Test-Path $path) "Missing context artifact: $path" }
