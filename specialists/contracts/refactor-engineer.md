...
- **Required records:** `REFACTOR_PLAN.md`, `BEHAVIOR_INVARIANTS.md`, approved requirements, affected-owner handoff, tests, rollback plan, `knowledge/engineering/CODE_QUALITY.md`, and only applicable approved stack modules.
