...
- **Context:** use diff-first compiled routing when available; request broader repository context only for unclear boundaries, migrations, or architectural review, and return a compact delta.
