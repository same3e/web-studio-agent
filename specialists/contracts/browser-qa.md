...
- **Context:** use the compiled role manifest when available; require routes, visible criteria, and selected cards, avoid unrelated backend methodology, and return a compact delta with actual runtime evidence or an unavailable reason.
