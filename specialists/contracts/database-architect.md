...
- **Inputs / records:** brief, technical decision, approved scope, acceptance criteria, relevant backend/API/security/integration records, and `knowledge/engineering/CODE_QUALITY.md`.
