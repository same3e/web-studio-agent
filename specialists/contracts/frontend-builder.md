...
- **Context:** use the compiled role manifest when available; request missing required records explicitly, do not load excluded history without reason, and return a compact delta with changes, evidence, blockers, and handoff.
